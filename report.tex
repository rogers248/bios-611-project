...
\subsection{Country and Meets}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[scale = 0.6]{Figures/Country_and_Meet.png}
	\end{figure}
...
\subsection{Weight Class for Men and Women}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[scale = 0.6]{Figures/Men_Weight_Class.png}
	\end{figure}
	\begin{figure}[H]
	\centering
	\includegraphics[scale = 0.6]{Figures/Women_Weight_Class.png}
	\end{figure}
...
\subsection{Wilk: Highest Wilk for Men and Women}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[scale = 0.6]{Figures/Highest_Wilk_for_Men.png}
	\end{figure}
	\begin{figure}[H]
	\centering
	\includegraphics[scale = 0.6]{Figures/Highest_Wilk_for_Women.png}
	\end{figure}
...
\subsection{Relationships between lifted weights and body weights}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[scale = 0.6]{Figures/Relationship_between_lifted_weights_and_body_weights.png}
	\end{figure}
